  ...
  const PRESETS = [
    { id: "drawing", name: "Dibujo",
      ...
      panels: [
        ...
        { id: "layers",   dock: "right",  size: 250 },
        { id: "color",    dock: "right",  size: 250 },
        { id: "timeline", dock: "bottom", size: 92 },
    ...
    { id: "animation", name: "Animación",
      ...
      panels: [
        { id: "tools",    dock: "left",   size: 56 },
        { id: "canvas",   dock: "center" },
        { id: "xsheet",   dock: "right",  size: 330 },
        { id: "timeline", dock: "bottom", size: 240 },
    ...
    { id: "color", name: "Color",
      ...
      panels: [
        { id: "tools",    dock: "left",   size: 56 },
        { id: "canvas",   dock: "center" },
        { id: "color",    dock: "right",  size: 300 },
        { id: "layers",   dock: "right",  size: 300 },
        { id: "timeline", dock: "bottom", size: 92 },
        { id: "xsheet",   hidden: true },
    ...
    { id: "composite", name: "Composición",
      ...
      panels: [
        { id: "canvas",   dock: "center" },
        { id: "layers",   dock: "right",  size: 280 },
        { id: "code",     dock: "right",  size: 280 },
        { id: "timeline", dock: "bottom", size: 200 },
